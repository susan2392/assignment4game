...
public class Player {
	...
	public boolean balanceExceedsLimitBy(int amount) {
		return (balance - amount >= limit); //Fixed bug 2: The betting limit will now be correctly reached.
	}
	...
	public void receiveWinnings(int winnings, int bet) {
		...
		balance = balance + winnings + bet; //Fixed bug 1: Game will now payout at corrected level.
	}
